...
export default function VideoCanvas() {
  return (
    <div className="w-full h-full bg-base flex items-center justify-center overflow-hidden">
      {/* Sleek full-screen placeholder instead of boxed aspect-video */}
      <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-surface to-surfaceDark">
